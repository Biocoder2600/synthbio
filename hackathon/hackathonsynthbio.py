...
for i in range(0, 10):
    k1 = random.uniform(0.05, 1)
    k2 = random.uniform(10, 100)
    k3 = random.uniform(0.05, 1)
    k4 = random.uniform(0.05, 1)
    k5 = random.uniform(0.05, 1)
    k6 = random.uniform(1.0 / 60.0, 1.0 / 5000.0)
    k7 = random.uniform(1.0 / 2500.0, 1.0 / 10000000.0)
    S1 = 10.0
    k9 = random.uniform(0.05, 1)
    k10 = random.uniform(0.05, 1)
    k11 = random.uniform(0.05, 1)
    ...
    constants = {'k1': str(k1), 'k2': str(k2), 'k3': str(k3), 'k4': str(k4), 
        ...
        'Km10': str(Km10), 'Km11': str(Km11), 'inter': str(inter), 'S1': str(S1)}
